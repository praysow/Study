...
x_train = x_train.reshape(x_train.shape[0],18,3)
x_test = x_test.reshape(x_test.shape[0],18,3)
...
#2.모델구성
model=Sequential()
model.add(Conv1D(filters=32,kernel_size=2,input_shape=(18,3),activation='relu'))
model.add(Flatten())
