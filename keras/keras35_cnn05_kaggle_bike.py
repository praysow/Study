...
x_train = x_train.values.reshape(x_train.shape[0],8,1,1)
x_test = x_test.values.reshape(x_test.shape[0],8,1,1)
test_csv = test_csv.values.reshape(test_csv.shape[0],8,1,1)
...
#2.모델구성
model=Sequential()
model.add(Conv2D(32, (1,1),input_shape=(8,1,1),activation='relu'))
