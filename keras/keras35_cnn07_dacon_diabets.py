...
test_csv=test_csv.values.reshape(test_csv.shape[0],2,2,2)
...
x_train=x_train.values.reshape(x_train.shape[0],2,2,2)
x_test=x_test.values.reshape(x_test.shape[0],2,2,2)
...
# #2.모델구성
model=Sequential()
model.add(Conv2D(32, (2,2),input_shape=(2,2,2),activation='relu'))
