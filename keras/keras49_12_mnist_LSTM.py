...
from keras.layers import Dense,LSTM     #Flatten: 평탄화시키다,데이터들을 전부다 펴주는 역할
...
model = Sequential()
model.add(LSTM(10, input_shape=(28, 28)))      #(2,2)를 사용했더니 (28,28,1)이 input의 4를 더해서 (n,27,27,4)가 된다
...
loss 0.45592471957206726
acc 0.8442000150680542
걸린시간 : 537
'''