...
from keras.layers import Dense, Dropout, Input, AveragePooling2D, Flatten,MaxPooling2D, Conv2D
...
#2.모델구성
model=Sequential()
model.add(Conv2D(10,(2,1),input_shape=(13,1,1),activation='relu'))
