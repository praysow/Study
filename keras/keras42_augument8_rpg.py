...
y_augumented = y_train.iloc[randidx].copy()
x_augumented= x_augumented.reshape(-1,150,150,1)
...
model = Sequential()
model.add(Conv2D(32,(3,3), input_shape=(150,150,1),strides=1,padding='same'))
