...
model = HalvingRandomSearchCV(RandomForestRegressor(),parameters, cv = kfold,verbose=1,refit=True,n_jobs=-1,random_state=6,factor=3.5,min_resources=50)     #데이터를 최대한 사용하고싶다면 factor와,min_resources 를 조절하자
...
베스트 스코어 0.761725723650495
model 스코어 0.7843032881992185
'''