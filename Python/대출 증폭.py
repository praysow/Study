...
x_train,x_test,y_train,y_test=train_test_split(x,y_ohe,train_size=0.85,random_state=333 ,
                                               stratify=y_ohe
                                               )
...
'''
f1 0.8416197348439347
로스: 0.38235846161842346
acc 0.8682243227958679
'''
