...
while True:
    ...
    x_train, x_test, y_train, y_test = train_test_split(x, y_ohe1, train_size=0.9,
                                                    random_state=r,        #346
                                                    # stratify=y_ohe1            
                                                    )
...
# 3.컴파일 훈련
    ...
    hist=model.fit(x_train, y_train, epochs=1500, batch_size=18567, validation_split=0.3,verbose=2,
          callbacks=[es]
            )
