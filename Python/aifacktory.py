...
def FCN(nClasses, input_height=128, input_width=128, n_filters = 16, dropout = 0.1, batchnorm = True):
    ...
    x = Conv2D(n_filters, (3, 3), activation='relu', padding='same', name='block1_conv3')(x)
    f1 = x
    ...
    x = Conv2D(n_filters, (3, 3), activation='relu', padding='same', name='block2_conv3')(x)
    f2 = x
...
# model.load_weights('c:/_data/aifac/sanbul/bulweghit1.h5')
...
for i in test_meta['test_img']:
    img = get_img_762bands(f'c:/_data/aifac/sanbul/test_img/{i}')
...
joblib.dump(y_pred_dict, 'c:/_data/aifac/sanbul/bul1.pkl')