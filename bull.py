...
# 최종 가중치 저장 이름
FINAL_WEIGHTS_OUTPUT = 'model_{}_{}_bull22.h5'.format(MODEL_NAME, save_name)
...
## model 훈련
"""
model.load_weights('c:/_data/aifac/sanbul/attention/bull21.hdf5')
print('---model 훈련 시작---')
...
joblib.dump(y_pred_dict, 'c:/_data/aifac/bull22.pkl')
