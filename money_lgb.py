...
best_model.booster_.save_model("c:/_data/dacon/soduc/weight/money39_lgb_optuna.csv")

# 테스트 데이터 예측 및 저장
y_pred_test = best_model.predict(test)
sample['Income'] = y_pred_test
sample.to_csv("c:/_data/dacon/soduc/csv/money39_lgb_optuna.csv", index=False)
print('Best parameters:', best_params)
