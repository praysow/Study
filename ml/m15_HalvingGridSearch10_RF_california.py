...
model = HalvingGridSearchCV(RandomForestRegressor(),parameters, cv = kfold,verbose=1,refit=True,n_jobs=-1,random_state=6,factor=3.5,min_resources=100)     #데이터를 최대한 사용하고싶다면 factor와,min_resources 를 조절하자
...
베스트 스코어 0.7628230690960777
model 스코어 0.7943738894416643
'''