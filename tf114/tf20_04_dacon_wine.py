...
# Weight와 Bias 변수 정의
w1 = tf.compat.v1.Variable(tf.compat.v1.random_normal([12,3]),name='weight1')
...
train = tf.compat.v1.train.GradientDescentOptimizer(learning_rate=0.5).minimize(loss_fn)
